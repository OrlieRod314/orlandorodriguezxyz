...
<html lang="en-US">
	...
	<body>
		<header>
			<h1 class="title">A New School Year</h1>
		</header>
		<?php
		...
		?>
				...
				<ul>
    <li><a href="#this-summer">This Summer</a></li>
   ...
   <p>Unfortunately, since I am at-risk for severe complications from COVID, I am unable to attend fencing practice. It’s not decided yet if we’re even going to be <em>allowed</em> to meet on campus, so it may turn out that <strong>no one</strong> can go. I think it’s very unfortunate because fencing is one of my strongest passions and I would be mad if I had to miss out on five <em>more</em> months.</p>
   <p>Here’s hoping I can eventually travel with the team and have fun.</p>
   <h2 id="university-response-to-covid-19">University Response to COVID-19</h2>
   ...
   <p>Flex In-Person classes are a shitty way of saying “We have an administration that’s horribly <em>inflexible</em>”. They’re basically classes that are partially physical and online. This is obviously a bad idea because if the whole goal is to keep students safe, then they shouldn’t be on campus. It’s an inconvenient compromise between keeping students safe at home, and keeping them on campus to generate revenue at the food courts and bookstore.</p>
   ...
   <p>Anyways, I consider myself fortunate that all my classes are online. This way, I can skip out on having to pay rent this semester, and I can pocket a nice fat check from the Bursar’s Office.</p>
   <h2 id="anime-ive-watched">Anime I’ve Watched</h2>
   <h3 id="neon-genesis-evangelion">Neon Genesis Evangelion</h3>
   ...
   <p>I found it interesting how some of my thought process aligned with Light at certain points. I did some analysis about MBTI types and turns out that L and Light are close to the INTJ area which is what I am. In fact, some people argue that Light is indeed an INTJ.</p>
			...
			<div class="post-notes">
				<ul>
    <li>I ship Asuka and Shinji btw.</li>
    </ul>
			</div>
					</div>
			</body>
