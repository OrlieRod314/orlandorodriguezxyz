...
<html lang="en-US">
	...
	<body>
		<header>
			<h1 class="title">Cicada 3301- The Holy Grail</h1>
		</header>
		<?php
    ...
    <li><a href="#conclusion">Conclusion</a></li>
				...
				<p>Regarded as “the most elaborate and mysterious puzzle of the internet age”, <em>CICADA 3301</em> is a mysterious organization that attempted to recruit codebreakers starting in 2012. I have included the puzzle-solving process, and provided my own speculation on the purpose/meaning behind the organization.</p>
    <p>Part of a series on Cicada 3301.</p>
			</div>
					</div>
		<div class="container main">
			<h2 id="chan">4chan</h2>
   <p><a href="https://www.4chan.org">4chan</a> is an anonymous imageboard site originally created as an english equivalent to the <a href="https://www.2chan.net">Futaba Channel</a>. Users can post images with captions in a specific topic board. There is no registration on the site and users can post anonymously, often referring to each other as <em>anon</em>. Since its inception in 2003, 4chan has gained notoriety and fame for the audience it has attracted as well as the actions of said audience.</p>
   ...
   <h2 id="initial-image">Initial Image</h2>
   <p>The first puzzle was posted January 4, 2012 on 4chan’s /x/ (Paranormal) board.</p>
    <div class="pic-container">
    <img src="/images/cicada/cicada-3301-invitation-original.jpg" alt="Original Cicada image">
    <div class="pic-title">
    <p>The Beginning</p>
    </div>
    </div>
   <p>Upon running the image through a text-editor such as notepad, a message is revealed. Anyone with basic cryptology knowledge would know to run the message through a Caesar Cypher. Doing so will yield an <a href="https://i.imgur.com/m9sYK.jpg">imgur link</a>.</p>
   <p>The link leads to a .jpeg image of a decoy duck. Now, there’s a bit of wordplay going on in the image. And the next step relies on some knowledge about image color and steganography.</p>
    <div class="pic-container">
    <img src="/images/cicada/cicada-outguess-hint.jpg" alt="Cool Decoy Duck">
    <div class="pic-title">
    <p>Cool Decoy Duck</p>
    </div>
    </div>
   <h3 id="aside-jpeg-and-steganography">Aside: JPEG and Steganography</h3>
   ...
   <h3 id="outguessing-the-duck">Outguessing the Duck</h3>
...
3301 
   ...
   <h2 id="the-subreddit">The Subreddit</h2>
...
-----END PGP SIGNATURE-----
   ...
   <h3 id="aside-pgp-explained">Aside: PGP Explained</h3>
   ...
   <p>The weird symbols at the top of the Reddit page are in fact Mayan numerals, and they can be translated. The resulting string of integers can be applied to the post titles on the same page by shifting the letters in reverse order. The titles combine to form a part of <a href="https://en.wikipedia.org/wiki/Mabinogion">The Mabinogian</a>, specifically <a href="https://sacred-texts.com/neu/celt/mab/mab05.htm">The Lady of the Fountain</a>. Looking back at the file obtained after outguessing the duck, you’ll see a series of numbers separated by colons. This is a book cipher.</p>
<p>Mayan Numerals:</p>
<pre>
...
Good luck. Goodbye.
   ...
   <p>The first Cicada image was 509x503 which are prime numbers. Multiplying it by 3301 would yield 845145127, so http://845145127.com (which does not exist anymore).</p>
